...
$pageTitle = 'Receptionist Desk - Doctor View';
...
<body class="bg-gray-50 flex h-screen overflow-hidden dark:bg-gray-900 transition-colors">
    ...
    <div class="flex-1 flex flex-col h-screen overflow-hidden relative">
        <nav class="bg-teal-900 text-white p-4 md:hidden flex justify-between items-center shadow-md">
            <h1 class="text-xl font-bold">Reception Desk</h1>
            <div class="flex items-center gap-2">
                <a href="dashboard.php" class="px-3 py-1 bg-teal-600 hover:bg-teal-700 rounded font-bold text-xs transition">Live Queue</a>
                <a href="logout.php" class="px-3 py-1 bg-red-600 hover:bg-red-700 rounded font-bold text-xs transition">Logout</a>
            </div>
        </nav>
        ...
        <main class="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8">
            ...
            <div class="flex justify-between items-end mb-6">
                <div>
                    ...
                    <p class="text-gray-500 dark:text-gray-400 font-semibold mt-1">Patient registration, intake & queue management (Doctor View)</p>
                </div>
                <div>
                    <a href="dashboard.php" class="bg-teal-600 hover:bg-teal-700 text-white font-bold px-4 py-2 rounded-xl shadow transition flex items-center gap-2 text-sm focus:outline-none">
            ...
            <div class="flex items-center gap-2 mb-6 border-b border-gray-200 dark:border-gray-700 pb-3">
                <a href="dashboard.php" class="px-5 py-2.5 rounded-xl font-bold text-sm transition flex items-center gap-2 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-700 shadow-sm">
                    <span>🩺</span> Doctor Live Queue
                </a>
                <a href="reception.php" class="px-5 py-2.5 rounded-xl font-bold text-sm transition flex items-center gap-2 bg-teal-600 text-white shadow-md shadow-teal-500/20">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 h-auto">
                ...
                <div class="col-span-1 space-y-6">
                    ...
                    <!-- Search Patient -->
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 border-t-4 border-teal-500">
                        <h2 class="text-lg font-black mb-4 text-gray-800 dark:text-gray-100 flex items-center gap-2">
                            <span>🔍</span> 1. Select Existing Patient
                        </h2>
                        <input type="text" id="searchInput" class="w-full border-2 border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-xl p-3 mb-2 focus:outline-none focus:border-teal-500 focus:ring-0 font-bold" placeholder="Search Name, Phone, NIC...">
                    ...
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 border-t-4 border-green-500">
                        <h2 class="text-lg font-black mb-4 text-gray-800 dark:text-gray-100 flex items-center gap-2">
                            <span>➕</span> 2. Register New Patient
                        </h2>
                ...
                <div class="col-span-1 lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6 h-auto">
                            ...
                            <table class="w-full text-left border-collapse">
                                <thead>
                                    <tr class="text-gray-400 text-xs uppercase tracking-widest border-b-2 border-gray-100 dark:border-gray-700">
                                        ...
                                        <th class="p-3 font-black text-right">Stage & Actions</th>
                                    </tr>
                                </thead>
                    ...
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 border-t-4 border-green-500 flex flex-col min-h-[500px]">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <span class="px-3 py-1 bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-full text-[10px] font-bold uppercase tracking-widest border border-green-200 dark:border-green-800">Billing</span>
                        </div>
    ...
    <div id="editPatientModal" class="fixed inset-0 z-50 flex items-center justify-center hidden bg-black bg-opacity-50">
        <div class="bg-white dark:bg-gray-800 dark:text-white rounded-2xl shadow-xl w-full max-w-lg p-6 m-4 relative border border-gray-100 dark:border-gray-700">
            <button onclick="closeEditPatientModal()" class="absolute top-4 right-4 text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 text-2xl font-bold">&times;</button>
            ...
            <form id="editPatientForm" class="space-y-3">
                ...
                <button type="submit" class="w-full bg-teal-600 hover:bg-teal-700 text-white font-bold py-2.5 rounded-xl transition">Save Patient</button>
    ...
    <div id="billModal" class="fixed inset-0 z-50 flex items-center justify-center hidden bg-black bg-opacity-50">
        <div class="bg-white dark:bg-gray-800 dark:text-white rounded-2xl shadow-xl w-full max-w-md p-6 m-4 relative border border-gray-100 dark:border-gray-700">
            <button onclick="closeBillModal()" class="absolute top-4 right-4 text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 text-2xl font-bold">&times;</button>
    ...
    <div id="historyModal" class="fixed inset-0 z-50 flex items-center justify-center hidden bg-black bg-opacity-50">
        <div class="bg-white dark:bg-gray-800 dark:text-white rounded-2xl shadow-xl w-full max-w-4xl h-[85vh] p-6 m-4 relative border border-gray-100 dark:border-gray-700 flex flex-col">
            <button onclick="closeHistoryModal()" class="absolute top-4 right-4 text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 text-2xl font-bold">&times;</button>
            <h3 class="text-xl font-black text-gray-800 dark:text-gray-100 mb-4 flex items-center gap-2">
    ...
    <script>
        ...
        document.getElementById('addPatientForm').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (result.success) {
                    if (action === 'queue') {
                        const qRes = await addToQueue(result.patient_id, false);
                        msg.className = 'text-green-600 dark:text-green-400 text-sm font-bold mt-2';
                        msg.innerText = 'Registered & Queued!';
                        const tokenText = (qRes && qRes.queue_number) ? ` as Token #${qRes.queue_number}` : '';
                        showToast(`Patient registered and queued${tokenText}!`);
                    } else {
                        msg.className = 'text-green-600 dark:text-green-400 text-sm font-bold mt-2';
                    ...
                    msg.className = 'text-red-600 dark:text-red-400 text-sm font-bold mt-2';
                    msg.innerText = result.error;
                    showToast(result.error, 'error');
                }
            } catch(err) {
                showToast('Network error while registering patient.', 'error');
            }
        });
        ...
        document.getElementById('searchInput').addEventListener('keydown', (e) => {
            ...
            if (e.key === 'ArrowDown') {
                ...
                if (selectedResultIndex >= 0 && selectedResultIndex < results.length) {
                    e.preventDefault();
                    const btn = results[selectedResultIndex].querySelector('button.btn-send-queue');
                    if (btn) btn.click();
                }
        ...
        function highlightSearchResult(results) {
            results.forEach((el, idx) => {
                if (idx === selectedResultIndex) {
                    el.classList.add('bg-teal-100', 'border-teal-300', 'dark:bg-teal-900/40');
                    el.classList.remove('bg-white', 'border-gray-100', 'dark:bg-gray-750');
                    el.scrollIntoView({ block: 'nearest' });
                } else {
                    el.classList.remove('bg-teal-100', 'border-teal-300', 'dark:bg-teal-900/40');
                    el.classList.add('bg-white', 'border-gray-100', 'dark:bg-gray-750');
                }
            });
        }
        ...
        document.getElementById('searchInput').addEventListener('input', debounce(async (e) => {
            ...
            try {
                ...
                resBox.innerHTML = patients.map((p, idx) => `
                    <div class="p-3 border border-gray-100 dark:border-gray-700 rounded-xl hover:bg-teal-50 dark:hover:bg-gray-700 cursor-pointer flex justify-between items-center transition group mb-2 bg-white dark:bg-gray-750 shadow-sm" data-index="${idx}">
                        <div>
                            <div class="font-black text-gray-800 dark:text-gray-100 text-sm">
                                <a href="#" onclick="openPatientHistoryModal(${p.PatientID}); return false;" class="hover:underline text-teal-600 dark:text-teal-400">${p.FirstName} ${p.LastName}</a>
                            </div>
                        ...
                        <div class="flex gap-1">
                            <button onclick="openEditPatientModal(${p.PatientID})" class="bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200 text-xs font-bold px-2 py-2 rounded-lg transition">Edit</button>
                            <button onclick="addToQueue(${p.PatientID}, true)" class="btn-send-queue bg-teal-600 hover:bg-teal-700 text-white text-xs font-bold px-3 py-2 rounded-lg shadow transition transform active:scale-95">Send Queue</button>
                        </div>
                    </div>
                `).join('');
            } catch(e) {
                resBox.innerHTML = '<div class="p-3 text-red-400 font-bold text-sm text-center">Error fetching results.</div>';
            }
        }, 300));
        ...
        async function addToQueue(patientId, showAlert) {
            ...
            const ghostRow = `
                <tr class="bg-purple-50 dark:bg-purple-900/10 transition border-b border-purple-100 dark:border-purple-900 animate-pulse">
                    ...
                    <td class="p-3">
                        ...
                        <div class="text-[10px] text-gray-300 font-bold uppercase tracking-wider mt-1">Adding patient to queue</div>
                    </td>
            ...
            try {
                ...
                const result = await res.json();
                if(result.success) {
                    if(showAlert) showToast(`Dispatched! Queue Token: #${result.queue_number}`, 'success');
                    fetchQueueAndStats();
                    return result;
                } else {
                ...
                if(showAlert) showToast('Network error adding to queue.', 'error');
                fetchQueueAndStats();
                return null;
            }
        }
        ...
        async function markPaid(visitId) {
            try {
                ...
                const result = await res.json();
                showToast(result.success ? 'Marked as paid.' : `Error: ${result.error}`, result.success ? 'success' : 'error');
                fetchQueueAndStats();
            } catch(e) {
        ...
        document.getElementById('editPatientForm').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                msg.classList.remove('hidden');
                msg.className = result.success ? 'text-teal-600 dark:text-teal-400 text-sm font-bold text-center' : 'text-red-600 text-sm font-bold text-center';
                msg.innerText = result.success ? 'Saved successfully.' : `Error: ${result.error}`;
                if (result.success) {
                ...
                showToast('Failed to save patient changes.', 'error');
            }
        });
        ...
        async function fetchQueueAndStats() {
            try {
                ...
                if(activeQueue.length === 0) {
                     const emptyActiveHTML = '<tr><td colspan="3" class="p-10 text-center font-black text-gray-300 dark:text-gray-600 text-md">Waiting line is empty.</td></tr>';
                    ...
                    const newActiveHTML = activeQueue.map(q => {
                        let statusBadge = '';
                        if(q.Status === 'waiting') statusBadge = '<span class="px-2.5 py-1 bg-yellow-100 text-yellow-800 rounded-full text-[10px] font-bold uppercase tracking-widest border border-yellow-200">Wait Area</span>';
                        else if(q.Status === 'with_doctor') statusBadge = '<span class="px-2.5 py-1 bg-teal-100 text-teal-800 rounded-full text-[10px] font-bold uppercase tracking-widest border border-teal-200 animate-pulse">In Room</span>';

                        let callBtnText = q.Status === 'with_doctor' ? 'Continue Diagnosis' : 'Call & Diagnose';
                        return `
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition border-b border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800">
                            ...
                            <td class="p-3">
                                <div class="font-bold text-gray-800 dark:text-gray-100">
                                    <a href="#" onclick="openPatientHistoryModal(${q.PatientID}); return false;" class="hover:underline text-teal-600 dark:text-teal-400">${q.FirstName} ${q.LastName}</a>
                                </div>
                                <div class="text-[10px] text-gray-500 dark:text-gray-400 font-bold uppercase tracking-wider mt-1">
                                    ...
                                    <span class="text-teal-600 dark:text-teal-400 font-black ml-1 bg-teal-50 dark:bg-teal-900/30 px-1 py-0.5 rounded border border-teal-100 dark:border-teal-900">Visits: ${q.PreviousVisits || 0}</span>
                                </div>
                            </td>
                            <td class="p-3 text-right">
                                ${statusBadge}
                                <div class="mt-2 flex justify-end gap-1 flex-wrap">
                                    <button onclick="startVisit(${q.QueueID}, ${q.PatientID})" class="px-2.5 py-1 bg-teal-600 hover:bg-teal-700 text-white rounded text-[10px] font-bold shadow-sm">${callBtnText}</button>
                                    <button onclick="openEditPatientModal(${q.PatientID})" class="px-2 py-1 bg-gray-100 dark:bg-gray-750 hover:bg-gray-200 text-gray-700 dark:text-gray-300 rounded text-[10px] font-bold">Edit</button>
                                    <button onclick="removeFromQueue(${q.QueueID})" class="px-2 py-1 bg-red-50 dark:bg-red-900/20 hover:bg-red-100 text-red-600 dark:text-red-400 rounded text-[10px] font-bold">Remove</button>
                                </div>
                            </td>
                        </tr>
                        `;
                ...
                if(completedQueue.length === 0) {
                     const emptyCompletedHTML = '<tr><td colspan="3" class="p-10 text-center font-black text-gray-300 dark:text-gray-600 text-md">No completed visits today.</td></tr>';
                    ...
                    const newCompletedHTML = completedQueue.map(q => {
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition border-b border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800">
                            ...
                            <td class="p-3 text-right">
                                ...
                                ${q.IsPaid == 1 ? '<div class="mt-1 text-[10px] font-black text-green-700 dark:text-green-400">Paid</div>' : `<button onclick="markPaid(${q.VisitID})" class="mt-1 text-[10px] font-black text-white bg-teal-600 hover:bg-teal-700 px-2 py-1 rounded shadow-sm">Mark Paid</button>`}
                            </td>
                        </tr>
                        `;
                    }).join('');
            ...
            try {
                ...
                if (data.success) {
                    ...
                    content.innerHTML = `
                        ...
                        <div class="pt-4">
                            ${visit.IsPaid == 1 ? '<div class="w-full text-center bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-300 font-black py-2.5 rounded-xl mb-2">Paid</div>' : `<button onclick="markPaid(${visit.VisitID}); closeBillModal();" class="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-2.5 rounded-xl transition mb-2">Mark Paid</button>`}
        ...
        function openPatientHistoryModal(patientId) {
            ...
            iframe.src = `history.php?patient_id=${patientId}&embed=true`;
            modal.classList.remove('hidden');
        }
