...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        foreach(['clinic_name', 'doctor_name', 'doctor_qualifications', 'doctor_slmc', 'clinic_address', 'clinic_phone', 'clinic_email', 'print_page_size', 'print_text_size', 'logo_width', 'backup_drive_url'] as $key) {
            if(isset($data[$key])) {
